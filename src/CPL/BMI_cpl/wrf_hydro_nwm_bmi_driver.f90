...
! =======
  ...
  call stat_check(wrf_hydro%get_var_grid(var_name, var_grid), stat)
  call stat_check(wrf_hydro%get_var_type(var_name, type_name), stat)
  call stat_check(wrf_hydro%get_var_units(var_name, var_unit), stat)
  call stat_check(wrf_hydro%get_grid_size(var_grid, grid_size), stat)
  call stat_check(wrf_hydro%get_var_itemsize(var_name, item_size), stat)
  call stat_check(wrf_hydro%get_var_nbytes(var_name, nbytes), stat)
